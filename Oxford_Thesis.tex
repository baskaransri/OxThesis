...
\title{Learning on Graphs with Incomplete Information}
...
\mdfdefinestyle{baskyBoxstyle}{
  linecolor=cyan,
  roundcorner=5pt,
  linewidth=1pt,
}

\surroundwithmdframed[style=baskyLinestyle]{theorem}
%\theoremstyle{definition}
...
%\include{text/last_chapter_intro}
\include{text/proj1_LS}
\include{text/proj1_GLR}
\include{text/proj2}
...
\include{text/appendix-proj1_LS}
\include{text/appendix-proj1_GLR}
\include{text/appendix-proj2}
...
The fox knows many things, but the hedgehog knows one big thing.
  \qauthor{--- Archilochus, \emph{Diehl, Frag. 103.}}
\end{savequote}
