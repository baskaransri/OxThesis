...
\section{Introduction}
In the previous Chapter and in Chapter (LIT REVIEW), we identified the limitations of the GSP literature around the analysis of reconstruction error with regards to sample size -- how the literature lacked theoretical analysis which covers the full range of possible sample sizes and noise levels. In the last chapter, we provided a theoretical characterisation of when decreasing sampling size could decrease reconstruction error, and derived the conditions under which this would happen for Least Squares reconstruction, which requires high noise.
